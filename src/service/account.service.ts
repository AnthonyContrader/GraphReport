...
import { JhiTrackerService } from 'src/authJWT/tracker.service';
import { AccountDTO } from 'src/dto/account.dto';
import { SERVER_API_URL } from 'src/authJWT/app.constants';

@Injectable({ providedIn: 'root' })
export class AccountService extends AbstractService<AccountDTO> {
    public userIdentity: any;
    public authenticated = false;
    public authenticationState = new Subject<any>();

    constructor(http: HttpClient, private trackerService: JhiTrackerService) {
      super(http);
