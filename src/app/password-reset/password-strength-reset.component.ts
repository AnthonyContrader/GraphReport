...
@Component({
    selector: 'jhi-password-strength-reset',
    template: `
        <div id="strength">
    ...
    styleUrls: ['password-strength-reset.css']
})
export class PasswordStrengthResetComponent {
    ...
    set passwordToCheck(password: string) {
        if (password) {
            ...
            if (element.className) {
                this.renderer.setStyle(element, element.className, false);
            }
